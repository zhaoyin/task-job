...
public class DateTimeUtil {
	...
	public static String getTodayYyyyMmDd() {
		return DateTimeUtil.parseString(DateTimeUtil.getTime(), DateTimeUtil.FMT_YYYY_MM_DD);
	}
	...
	public static String getTodayYyyy() {
		return DateTimeUtil.parseString(DateTimeUtil.getTime(), DateTimeUtil.FMT_YYYY);
	}
	...
	public static String getStrTime() {
		return parseString(getTime(), DateTimeUtil.FMT_DEFAULT);
	}
	...
	public static String getSimpleTime(String timeStr) {
		Date time = DateTimeUtil.parseDate(timeStr);
	...
	public static String getSimpleTime(Date time) {
		long ssDiff = DateTimeUtil.getDateDiff(time, DateTimeUtil.getTime(), 0);
		...
		long mmDiff = DateTimeUtil.getDateDiff(time, DateTimeUtil.getTime(), 1);
		if(mmDiff < 60) {
			result.append(mmDiff).append("分钟前");
			return result.toString();
		}
		String timeStr = DateTimeUtil.parseString(time);
		if(DateTimeUtil.getTodayYyyyMmDd().equals(timeStr.substring(0, 10))) {
			result.append("今天 ").append(DateTimeUtil.parseString(time, "HH:mm"));
			return result.toString();
		}
		if(getTodayYyyy().equals(timeStr.substring(0, 4))) {
			return DateTimeUtil.parseString(time, "MM月dd日 HH:mm");
		}
		return DateTimeUtil.parseString(time, "yyyy年MM月dd日");
	}
}